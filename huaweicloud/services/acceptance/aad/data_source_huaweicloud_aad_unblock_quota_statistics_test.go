...
func TestAccAadUnblockQuotaStatisticsDataSource_basic(t *testing.T) {
	var (
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAadUnblockQuotaStatistics_basic(),
...
func testAadUnblockQuotaStatistics_basic() string {
	return fmt.Sprintf(`
