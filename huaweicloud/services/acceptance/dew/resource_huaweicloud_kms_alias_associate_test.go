...
func TestAccKmsAliasAssociate_basic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		PreCheck: func() {
			...
			acceptance.TestAccPreCheckTargetKmsKeyID(t)
		},
		ProviderFactories: acceptance.TestAccProviderFactories,
		CheckDestroy:      rc.CheckResourceDestroy(),
		Steps: []resource.TestStep{
			{
				Config: testKmsAliasAssociate_basic(aliasName),
				Check: resource.ComposeTestCheckFunc(
					rc.CheckResourceExists(),
					resource.TestCheckResourceAttr(rName, "target_key_id", acceptance.HW_KMS_TARGET_KEY_ID),
...
func testKmsAliasAssociate_basic(name string) string {
	return fmt.Sprintf(`
...
`, acceptance.HW_KMS_KEY_ID, name, acceptance.HW_KMS_TARGET_KEY_ID, name)
}
